...
inline constexpr int SUSTAIN_POINTS_PER_BEAT = 25;
...
inline constexpr float STAR_THRESHOLDS[5][6] = {
    { 0.06f, 0.12f, 0.20f, 0.45f, 0.75f, 0.95f }, // Drums
    { 0.05f, 0.10f, 0.19f, 0.47f, 0.78f, 0.95f }, // Bass
    { 0.06f, 0.12f, 0.20f, 0.47f, 0.78f, 0.95f }, // Guitar
    { 0.06f, 0.12f, 0.20f, 0.47f, 0.78f, 0.95f }, // Keys
    { 0.05f, 0.11f, 0.19f, 0.46f, 0.77f, 0.95f } // Vocals
};
inline constexpr float BAND_STAR_THRESHOLD[6] =
    { 0.06f, 0.12f, 0.20f, 0.47f, 0.78f, 0.95f };
